...
public class MALSearchResponse extends BaseObservable {
    ...
    public MALSearchResponse(String requestHash, Boolean requestCached, Integer requestCacheExpiry, List<MALResults> results, Integer lastPage) {
